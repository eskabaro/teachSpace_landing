...
export const uiClasses = ({ direction, align, gap, h, justify, grow, lg, md, p, radius, sm, w, maxW, wrap, xl, xxl, display, cols, shrink, textAlign }: UiType) => {
    return classnames(
        ...
        classNamesResolver('shrink_', shrink),
        classNamesResolver('xxl_shrink_', xxl?.shrink),
        classNamesResolver('xl_shrink_', xl?.shrink),
        classNamesResolver('lg_shrink_', lg?.shrink),
        classNamesResolver('md_shrink_', md?.shrink),
        classNamesResolver('sm_shrink_', sm?.shrink),
        ...
        classNamesResolver('text_', textAlign),
