...
const Transition: FC<Props> = ({ children, isOpen: initialOpen = false, duration = 200, timingFunction = 'ease', delay = 20, classNames, styles, unMountOnExited = true }) => {
    ...
    return (
        <>
            {cloneElement(children, {
                className: classnames(!classNames && !styles && transitionStates.length && s.opacity, ...transitionClasses, children.props.className),
